    ...
    <div className="p-6 space-y-5">
      ...
      {funcoes.length > 0 && (
        <div className="bg-white rounded-2xl border border-[var(--border)] shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-[1fr_140px_120px_100px_80px] gap-3 px-5 py-2.5 bg-[var(--muted)] border-b border-[var(--border)]">
          ...
          {ativos.map(m => (
            <div key={m.id}
              className="grid grid-cols-[1fr_140px_120px_100px_80px] gap-3 px-5 py-3.5 border-b border-[var(--border)] last:border-0 items-center hover:bg-[var(--muted)] transition-colors">
              <div>
      ...
      {inativos.length > 0 && (
        <div className="bg-white rounded-2xl border border-[var(--border)] shadow-sm overflow-hidden opacity-70">
          <div className="px-5 py-3 bg-[var(--muted)] border-b border-[var(--border)]">
            <span className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wide">
          ...
          {inativos.map(m => (
            <div key={m.id}
              className="flex items-center justify-between gap-3 px-5 py-3 border-b border-[var(--border)] last:border-0">
              <div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl border border-[var(--border)] shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">

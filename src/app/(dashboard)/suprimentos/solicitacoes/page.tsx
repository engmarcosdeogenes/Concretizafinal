...
import { ClipboardList, Plus, Clock, CheckCircle2, XCircle, AlertTriangle } from "lucide-react"
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-[var(--border)] shadow-sm overflow-hidden">
        <div className="grid grid-cols-[80px_1fr_120px_80px_100px_100px] gap-3 px-5 py-3 bg-[var(--muted)] border-b border-[var(--border)]">
        ...
        {!isLoading && solicitacoes.length === 0 && (
          <div className="py-12 text-center">
            ...
            <p className="text-sm font-medium text-[var(--text-primary)]">Nenhuma solicitação</p>
            <p className="text-xs text-[var(--text-muted)] mt-1">Crie a primeira solicitação de compra</p>
          </div>
        )}
        ...
        {solicitacoes.map(sol => {
          ...
          return (
            <Link
              ...
              className="grid grid-cols-[80px_1fr_120px_80px_100px_100px] gap-3 px-5 py-4 border-b border-[var(--border)] last:border-0 hover:bg-[var(--muted)] transition-colors items-center no-underline"
            >
